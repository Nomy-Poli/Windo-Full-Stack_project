...
namespace CMS_CORE_NG.Migrations
{
    ...
    [Migration("20221106111406_update-color-in-networkingBoard")]
    partial class updatecolorinnetworkingBoard
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelService.windoModels.Board", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            Color = "#47caeb",
                            Description = "כאן תראי מודעות הקשורות לנטוורקינג",
                            Name = "נטוורקינג"
                        });
                });
            ...
            modelBuilder.Entity("ModelService.windoModels.NetworkingGroupBusiness", b =>
                {
                    b.HasOne("ModelService.windoModels.Buisness", "Business")
                        .WithOne("NetworkingGroupBusinesses")
                        .HasForeignKey("ModelService.windoModels.NetworkingGroupBusiness", "BusinessId");
