...
namespace LoggingService
{
    public static class CustomConsoleThemes
    {
		...
		} = new CustomConsoleTheme(new Dictionary<ConsoleThemeStyle, string>
		{
			...
			[ConsoleThemeStyle.Text] = "\u001b[0m",
			[ConsoleThemeStyle.SecondaryText] = "\u001b[0m",
			[ConsoleThemeStyle.TertiaryText] = "\u001b[0m",
			[ConsoleThemeStyle.Invalid] = "\u001b[0m",
			[ConsoleThemeStyle.Null] = "\u001b[0m",
			[ConsoleThemeStyle.Name] = "\u001b[0m",
			[ConsoleThemeStyle.String] = "\u001b[0m",
			[ConsoleThemeStyle.Number] = "\u001b[0m",
			[ConsoleThemeStyle.Boolean] = "\u001b[0m",
			[ConsoleThemeStyle.Scalar] = "\u001b[0m",
			[ConsoleThemeStyle.LevelVerbose] = "\u001b[0m",
			[ConsoleThemeStyle.LevelDebug] = "\u001b[44;1m\u001b[37;1m",
			[ConsoleThemeStyle.LevelInformation] = "\u001b[42;1m\u001b[37;1m",
			[ConsoleThemeStyle.LevelWarning] = "\u001b[43;1m\u001b[37;1m",
			[ConsoleThemeStyle.LevelError] = "\u001b[41;1m\u001b[37;1m",
